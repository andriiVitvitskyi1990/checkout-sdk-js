...
export default class BraintreePaypalButtonStrategy implements CheckoutButtonStrategy {
    ...
    async initialize(options: CheckoutButtonInitializeOptions): Promise<void> {
        ...
        const { isBraintreeVenmoEnabled } = paymentMethod?.initializationData;
        ...
        return Promise.all([
            ...
            this._braintreeSDKCreator.getVenmoCheckout({isBraintreeVenmoEnabled: !!isBraintreeVenmoEnabled}, (venmoCheckoutInstance: VenmoInstance) => this._renderVenmoButton(venmoCheckoutInstance)),
