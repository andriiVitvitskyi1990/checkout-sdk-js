...
export default class BraintreePaypalButtonStrategy implements CheckoutButtonStrategy {
    ...
    async initialize(options: CheckoutButtonInitializeOptions): Promise<void> {
        ...
        return Promise.all([
            ...
            this._braintreeSDKCreator.getVenmoCheckout((venmoCheckoutInstance: VenmoInstance) => this.renderVenmoButton(venmoCheckoutInstance)),
    ...
    renderVenmoButton( venmoInstance: VenmoInstance) {
